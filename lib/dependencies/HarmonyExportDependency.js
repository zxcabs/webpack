...
function HarmonyExportDependency(name, range, rangeStatement, localModule) {
...
HarmonyExportDependency.prototype.type = "harmony export";
...
HarmonyExportDependency.Template.prototype.apply = function(dep, source) {
	...
	if(Array.isArray(name)) {
		var content = name.map(function(name) {
			return "Object.defineProperty(exports, " + JSON.stringify(name) + ", {configurable: false, enumerable: true, get: function() { return " + name + "; }});"
		}).join("");
		if(content) {
		...
		Object.keys(mapIdentifierToName).forEach(function(key) {
			...
			content += "Object.defineProperty(exports, " + JSON.stringify(name) + ", {configurable: false, enumerable: true, get: function() { return " + identifier + "; }});";
		});
